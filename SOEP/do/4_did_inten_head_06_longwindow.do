...
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_amount_06_longwindow.txt", ///
...
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_amount_06_longwindow.tex", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Effect of the 2006 Pension Reform on Amount Saved 06") ///
...
* Display Results Side-by-Side
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_rate_06_longwindow .txt", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Effect of the 2006 Pension Reform on Saving Rate 06") ///
    label stats(r2 N, fmt(3 0) labels("R-squared" "N"))

esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_rate_06_longwindow.tex", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Effect of the 2006 Pension Reform on Saving Rate 06") ///
    label booktabs drop(*.syear)
