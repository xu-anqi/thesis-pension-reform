...
esttab probit1 probit2 probit3 probit4 using "${OUT_OUTPUT}did_if_savings_probit_female.txt", ///
...
esttab ame1 ame2 ame3 ame4 using "${OUT_OUTPUT}ame_probit_female.txt", ///
