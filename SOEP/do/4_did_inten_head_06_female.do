...
graph export "${MY_OUTPUT_OUT}did_multiplegt_female.png", replace
...
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_amount_female.txt", ///
...
* Display Results Side-by-Side
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_rate_female.txt", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
