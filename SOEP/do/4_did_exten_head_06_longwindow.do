...
* Display Results Side-by-Side
esttab probit1 probit2 probit3 probit4 using "${OUT_OUTPUT}did_if_savings_probit_06_longwindow.txt", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
...
esttab ame1 ame2 ame3 ame4 using "${OUT_OUTPUT}ame_probit_longwindow.txt", ///
