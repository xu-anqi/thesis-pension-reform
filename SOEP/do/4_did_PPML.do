...
esttab ppml1 ppml2 ppml3 ppml4 ppml5 ppml6 using "${MY_OUTPUT_OUT}ppml_amount.txt", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("PPML: Effect of the 2007 Pension Reform on Amount Saved") ///
    label

esttab ppml1 ppml2 ppml3 ppml4 ppml5 ppml6 using "${MY_OUTPUT_OUT}ppml_amount.tex", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("PPML: Effect of the 2007 Pension Reform on Amount Saved") ///
    label booktabs
...
esttab ppmlr1 ppmlr2 ppmlr3 ppmlr4 ppmlr5 ppmlr6 using ///
    "${MY_OUTPUT_OUT}ppml_rate.txt", replace se b(3) ///
    star(* 0.10 ** 0.05 *** 0.01) ///
    title("PPML: Effect of the 2006 Pension Reform on Saving Rate") label

* LaTeX output
esttab ppmlr1 ppmlr2 ppmlr3 ppmlr4 ppmlr5 ppmlr6 using ///
    "${MY_OUTPUT_OUT}ppml_rate.tex", replace se b(3) ///
    star(* 0.10 ** 0.05 *** 0.01) ///
