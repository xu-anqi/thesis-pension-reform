...
log using "${OUT_LOG}5_did_inten_placebo.log", replace
...
graph export "${MY_OUTPUT_OUT}did_multiplegt.png", replace
...
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_amount.txt", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Placebo Test on Amount Saved") ///
    label

esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_amount.tex", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Placebo Test on Amount Saved") ///
...
* Display Results Side-by-Side
esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_rate.txt", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Placebo Test on Saving Rate") ///
    label

esttab lpm1 lpm2 lpm3 lpm4 lpm5 lpm6 using "${MY_OUTPUT_OUT}did_rate.tex", ///
    replace se b(3) star(* 0.10 ** 0.05 *** 0.01) ///
    title("Intensive Margin: Placebo Test on Saving Rate") ///
    label booktabs drop(*.syear)
