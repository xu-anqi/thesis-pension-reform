...
local files             2005/STATA/ZA4437_1_v5-0-0.dta ///
...
foreach f of local files {
	use `variables' using "${IN_DATA}/`f'", clear
	if `first' {
...
rename f65o1 exp_replacement_rate
...
local files             2005/STATA/ZA4437_indicator_v5-0-0.dta ///
...
replace financial_wealth      = financial_wealth / CPI * 81.5
replace financial_wealth_sq = financial_wealth^2
replace household_income = household_income / CPI * 81.5
