...
*** question not asked in year 2010
drop if year == 2010 
...
gen relative = .
replace relative = - f91o1 if f91s == 1
replace relative = 0	   if f91s == 2
replace relative =  f91o2 if f91s == 3



replace life_expectancy = life_expectancy + relative
...
replace life_expectancy = . if na_exp_life_expectancy_1 == 1
replace life_expectancy = . if na_exp_life_expectancy_2 == 1
replace life_expectancy = . if na_exp_life_expectancy_3 == 1
...
****
gen year_rtm = life_expectancy - era
